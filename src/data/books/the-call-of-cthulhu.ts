...
export const theCallOfCthulhu: Book = {
  ...
  chapters: [
  {
    ...
    text: `The most merciful thing in the world, I think, is the inability of the
...
mentioned by the professor.`
  },
  {
    ...
    text: `The older matters which had made the sculptor's dream and bas-relief so
...
he did remains to be seen, for I have learned much now.`
  },
  {
    ...
    text: `If heaven ever wishes to grant me a boon, it will be a total effacing
